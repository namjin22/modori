// 모도리의 캐릭터 "도리". 달력의 클로버 표시와 같은 네 잎 모양이다.
  ...
  party: {
    ...
    props: (
      <>
        ...
        <circle cx={12} cy={58} r={3} fill="#3ccf8e" />
      </>
    ),
  },
  calm: {
    ...
    behind: (
      <>
        <path d="M60 32 C60 26 60 22 60 16" stroke="#2aa36b" strokeWidth={3} strokeLinecap="round" />
        <path d="M60 22 C52 14 44 18 44 22 C50 26 56 26 60 22Z" fill="#6fe0a8" />
        <path d="M60 20 C68 12 77 16 77 20 C71 25 64 25 60 20Z" fill="#6fe0a8" />
      </>
    ),
  },
  sad: {
  ...
  return (
    ...
    >
      ...
      <g transform="translate(60 70) scale(1.06)">
        <g fill={SHADE}>
          <circle cx={-18} cy={-15} r={23} />
          <circle cx={18} cy={-15} r={23} />
          <circle cx={-18} cy={19} r={23} />
          <circle cx={18} cy={19} r={23} />
        </g>
        <g fill={BODY}>
          <circle cx={-18} cy={-18} r={22} />
          <circle cx={18} cy={-18} r={22} />
          <circle cx={-18} cy={15} r={22} />
          <circle cx={18} cy={15} r={22} />
          <circle cx={0} cy={-1} r={26} />
        </g>
        <ellipse cx={-24} cy={-28} rx={7} ry={4} fill="#fff" opacity={0.55} transform="rotate(-35 -24 -28)" />
